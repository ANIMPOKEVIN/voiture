                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle active" data-toggle="dropdown">vehicules</a>
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="../" class="dropdown-item">liste des vehicules</a>
                                <a href="../" class="dropdown-item active"> Detail sur le vehicule</a>
                ...
                <div class="col-lg-8 mb-5">
                    ...
                    <div class="row mx-n2 mb-3">
                        <div class="col-md-3 col-6 px-2 pb-2">
                            <img class="img-fluid w-100" src="../acceuil/img/gallery-1.jpg" alt="">
                        </div>
                        <div class="col-md-3 col-6 px-2 pb-2">
                            <img class="img-fluid w-100" src="../acceuil/img/gallery-2.jpg" alt="">
                        </div>
                        <div class="col-md-3 col-6 px-2 pb-2">
                            <img class="img-fluid w-100" src="../acceuil/img/gallery-3.jpg" alt="">
                        </div>
                        <div class="col-md-3 col-6 px-2 pb-2">
                            <img class="img-fluid w-100" src="../acceuil/img/gallery-4.jpg" alt="">
                        </div>
                    </div>
